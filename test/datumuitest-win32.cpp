...
struct Window
{
  ...
  void mousewheel(UINT msg, WPARAM wParam, LPARAM lParam);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
  switch (uMsg)
  {
    ...
    case WM_MOUSEWHEEL:
      window.mousewheel(uMsg, wParam, lParam);
      break;
...
void Window::init(HINSTANCE hinstance, Game *gameptr)
{
  ...
  winclass.lpszClassName = "DatumUiTest";
  ...
  hwnd = CreateWindowEx(dwexstyle, "DatumUiTest", "Datum Ui Test", dwstyle, CW_USEDEFAULT, CW_USEDEFAULT, rect.right - rect.left, rect.bottom - rect.top, NULL, NULL, hinstance, NULL);
...
//|//////////////////// Window::mousewheel //////////////////////////////////
void Window::mousewheel(UINT msg, WPARAM wParam, LPARAM lParam)
{
  game->inputbuffer().register_mousewheel(GET_WHEEL_DELTA_WPARAM(wParam) / WHEEL_DELTA);
}
